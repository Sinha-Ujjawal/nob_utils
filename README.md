...
| [`nob_bisect.h`](./src/nob_bisect.h)                   | No Dependencies                                                                                                                                       | Implemented Array Bisection Algorithms similar to [cpython](https://docs.python.org/3.13/library/bisect.html)                                                                                                                                                            |
| [`nob_prime.h`](./src/nob_prime.h)                     | Depends on [`nob.h`](./thirdparty/nob.h), [`nob_ext.h`](./src/nob_ext.h) and [`nob_bisect.h`](./src/nob_bisect.h)                                     | A naive implementation of checking if a number is prime using [Sieve of Eratosthenes](https://en.wikipedia.org/wiki/Sieve_of_Eratosthenes)                                                                                                                               |
| [`nob_shuffle.h`](./src/nob_shuffle.h)                 | Depends on [`nob.h`](./thirdparty/nob.h), [`nob_ext.h`](./src/nob_ext.h), [`nob_bisect.h`](./src/nob_bisect.h) and [`nob_prime.h`](./src/nob_prime.h) | A simple non-repeating shuffler inspired from [Tsoding Daily Video: Coding Playlist Shuffle Algorithm](https://youtu.be/SWNqgv7w_cY)                                                                                                                                     |

...
| [`nob_entity.h`](./src/nob_entity.h) | It is a library that provides a simple entity management system based on "Intrusive" list and Dynamic arrays | Depends on [`nob.h`](./thirdparty/nob.h) for the dynamic array, and [`nob_ilist.h`](./src/nob_ilist.h) for the Intrusive list impl. |
